  ...
  return (
    <form action={action} className="flex flex-col gap-3">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
        ...
        <div className="flex flex-1 flex-col gap-1.5">
          ...
          <input
            ...
            className="rounded-lg border border-input bg-background px-3 py-2 font-mono text-sm outline-none ring-offset-background placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
          />
        </div>
      ...
      <p className="text-xs text-muted-foreground">
        <LockIcon className="mr-1 inline size-3 -translate-y-px" />
        Your token is AES-256 encrypted and stored server-side only. It is never exposed to the
        browser. Requires <code className="font-mono">public_repo</code> scope for public
        repositories.
      </p>
